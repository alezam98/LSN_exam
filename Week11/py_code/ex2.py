...
def generate_model():
    ...
    model.add(tf.keras.layers.Dense(units=64, activation="relu", input_dim=1))
...
def main():
    ...
    # results
    plot_results(model, x_test, y_test, history, "loss", "../data/results_02.png", show_bool=False, save_bool=True)
    print_evaluation(metric, filename="../data/test_metric_02.dat", save_bool=True)
