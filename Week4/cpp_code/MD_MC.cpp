...
// distance i-j in pbc
  ...
  walker[ip] = rho * walker[it] + (1./3./vol) * 48.0 * w; // Pressure
...
void Averages(int iblk) //Print results for current block
{
   ...
   //const int wd=12; usata per set(wd)
    ...
    if(save == 0 && iblk == 1)
    {
      Epot.open("../data/"+dir+"/"+state+"_epot.dat",ios::out);
      Ekin.open("../data/"+dir+"/"+state+"_ekin.dat",ios::out);
      Temp.open("../data/"+dir+"/"+state+"_temp.dat",ios::out);
      Press.open("../data/"+dir+"/"+state+"_press.dat",ios::out);
      Etot.open("../data/"+dir+"/"+state+"_etot.dat",ios::out);
    ...
    {
      Epot.open("../data/"+dir+"/"+state+"_epot.dat",ios::app);
      Ekin.open("../data/"+dir+"/"+state+"_ekin.dat",ios::app);
      Temp.open("../data/"+dir+"/"+state+"_temp.dat",ios::app);
      Press.open("../data/"+dir+"/"+state+"_press.dat",ios::app);
      Etot.open("../data/"+dir+"/"+state+"_etot.dat",ios::app);
    }
