...
void genetic_algorithm::set_population(chromosome* population, int rank)
{
    for(int ichromo=0; ichromo<m_nchromo; ichromo++)
    {
        m_population[ichromo].sequence = population[ichromo].sequence;
        m_population[ichromo].fitness = population[ichromo].fitness;
    }
